...
git config --global --add safe.directory /home/vagrant/e4l-frontend
...
cd .
git clone http://192.168.56.12/gitlab/user1/e4l-frontend.git
cd e4l-frontend
cp -r /vagrant_data/e4l/lu.uni.e4l.platform.frontend.dev/* . 
cp /vagrant_data/scripts/frontend/.gitlab-ci.yml .
